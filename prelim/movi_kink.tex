...
A central feature of intergenerational mobility is that the transmission of income between parents and children is not uniform along the income distribution. This observation has been highlighted in the empirical literature, which points out that the relationship between parents’ and children’s incomes is non-linear even in canonical log–log specifications \parencite{Chetty_2014}. Consistent with this view, a growing body of work documents direct evidence of non-linearities in the intergenerational elasticity of income (IGE), with substantially higher persistence in specific segments of the parental income distribution. For the Nordic economies, \textcite{Bratsberg_2007} find a concave intergenerational relationship at the bottom and a convex one at the top of the distribution. At the international level, \textcite{Berritela_2016} document heterogeneity in intergenerational transmission, while for Latin America recent evidence shows that, although mobility is relatively high in the middle of the distribution, intergenerational persistence is considerably stronger at the top \parencite{Leites_2022,Cortes_2024,Britto_2022}.

These empirical patterns pose a challenge to standard models of intergenerational mobility \parencite{Becker_Tomes_1979,Solon_1999,Solon_2004}. In the canonical human capital investment framework, parental decisions respond smoothly and continuously to changes in income, generating approximately linear relationships between parents’ and children’s incomes. As a result, these models have difficulty explaining why intergenerational persistence is particularly high at the upper tail of the income distribution. This paper starts from this puzzle and proposes a mechanism that endogenously generates non-linearities in intergenerational income transmission.

A natural explanation for the presence of non-linearities in intergenerational mobility is that incentives to invest in human capital are not constant along the income distribution. In particular, if market returns to skills increase disproportionately beyond certain levels of human capital, small differences in parental resources can translate into amplified differences in investment decisions and, consequently, into higher intergenerational income persistence.

In this sense, the profound changes observed in wage structures since the 1980s provide a relevant empirical context for studying the origins of these non-linearities. Since the 1980s, wage inequality has increased substantially in both developed and developing economies. A central explanation for this phenomenon is skill-biased technological change, which has increased the relative demand for more skilled workers \parencite{Katz_1992,Krusell_2000,Card_2002,Buera_2021}. Along these lines, \textcite{Murphy_1993} argue that a substantial fraction of the increase in wage inequality can be attributed to higher returns to skill.

These changes in the structure of labor market returns not only affect the income distribution within a generation, but also have the potential to modify the mechanisms through which economic advantages are transmitted from parents to children. In particular, when returns to human capital increase, parental investment decisions play a central role in shaping children’s future income outcomes.

A natural channel through which to study this connection is human capital investment. In an environment in which the market increasingly rewards skills, it is plausible that parents face stronger incentives to invest in their children’s human capital in order to improve their future economic well-being. Under homogeneous returns to human capital, an increase in the return to skill would induce relatively uniform increases in parental investment, shifting the distribution of children’s incomes without substantially altering its relative composition.

This reasoning changes fundamentally when market returns to skills depend on the level of human capital attained and are increasing in that level. In such a case, parental investment decisions may respond non-linearly to small differences in parental income, giving rise to large and discrete changes in optimal investment. This structure is analogous to a tax system with bracketed marginal rates: just as incentives to generate income change when crossing income thresholds, incentives to invest in human capital change when surpassing specific levels of potential human capital. Unlike the tax case—where marginal rates typically reduce net returns—here marginal returns increase when thresholds are crossed, amplifying differences in investment incentives.

As a consequence, wealthier parents can finance investments sufficient to reach the levels of human capital most highly valued by the market and benefit from increasing returns. In contrast, lower-income parents, unable to cover the cost required to surpass these thresholds, tend to concentrate their investments at low levels of human capital accumulation. This mechanism generates persistent disparities in parental investment and lays the groundwork for lower intergenerational mobility, particularly at the upper end of the income distribution.

Increasing returns to human capital can arise from several mechanisms. On the one hand, the emergence of superstar economies \parencite{Rosen_1983,Autor_2020} has increased demand for highly skilled workers in talent-intensive firms, disproportionately raising returns at the top of the human capital distribution. In this context, reaching sufficiently high levels of human capital allows access to occupations and firms where accumulated skills are especially valued and thus more highly rewarded.

On the other hand, accumulating human capital beyond certain thresholds facilitates access to elite schools and universities, as well as to employers at more productive firms that differentially value such credentials \parencite{Zimmerman_2019,Chetty_2025}. Access to these environments not only directly increases the returns to invested human capital, but also enables the formation of valuable networks and connections \parencite{Bavaro_2022}, which can amplify initial disparities and generate inefficiencies associated with talent misallocation \parencite{Bandyopadhyay_2019}. Consistent with these mechanisms, empirical evidence shows that incomes at the top of the distribution largely reflect high returns to human capital. Executive compensation has increased substantially over recent decades \parencite{Gabaix_2008}, suggesting that the market rewards individuals with high levels of skill and human capital in an increasingly convex manner. Complementarily, using U.S. administrative data, \textcite{Smith_2019} document that a predominant share of income at the top percentile comes from pass-through business income associated with labor and entrepreneurial skills rather than from financial capital. Taken together, these findings suggest that, at the top of the distribution, income responds disproportionately to human capital accumulation, reinforcing the relevance of mechanisms featuring increasing returns.

From an aggregate empirical perspective, a salient fact in modern economies is the positive association between income inequality and intergenerational persistence, a regularity summarized by the so-called \emph{Great Gatsby Curve} \parencite{Corak_2013}. This pattern suggests that economies characterized by greater income dispersion tend to exhibit lower intergenerational mobility on average, placing social mobility at the center of economic and policy debates. In particular, the coexistence of high inequality and low mobility raises fundamental questions about equality of opportunity and challenges the extent to which income differences reflect meritocratic processes as opposed to the persistent transmission of economic advantage across generations.

In light of the mechanisms described above, the \emph{Great Gatsby Curve} can be interpreted as the aggregate manifestation of heterogeneous microeconomic responses to changes in the structure of returns to human capital. This interpretation fits within a literature that has sought to rationalize the link between inequality and intergenerational mobility from different perspectives \parencite{Becker_2018,Durlauf_2018,BouchardSt-Amant2024}, while emphasizing the role of parental investment decisions in the presence of non-linear returns to skill. In particular, when returns to skill investment are increasing and feature thresholds, rising wage inequality not only amplifies income dispersion within a generation, but also intensifies disparities in parental investment decisions. This mechanism generates higher intergenerational persistence, especially at the upper end of the income distribution, where access to high-return regimes is feasible.

This paper formalizes this intuition within an intergenerational model of human capital investment. We build on the classic framework of \textcite{Becker_Tomes_1979}, with simplifications following \textcite{Solon_1999}, and incorporate a structure of differentiated returns to human capital investment. This extension alters optimal parental investment decisions and, as a result, the properties of intergenerational income transmission.
...
Within the intergenerational mobility literature, some studies move more directly toward characterizing non-linearities across the entire income distribution. \textcite{Bratsberg_2007} document non-linear intergenerational income transmission in Denmark, Finland, and Norway. At the bottom of the distribution, they find a concave relationship between parental and children’s incomes, consistent with models featuring credit constraints on human capital investment \parencite{Becker_1986,Lochner_2011,Lochner_2020}. At the top of the distribution, the authors suggest the possibility of a convex relationship, motivated by increasing returns to skill investment at high levels of human capital. The interaction of both mechanisms yields an S-shaped relationship, characterized by lower intergenerational mobility at both the bottom and the top of the parental income distribution. However, their analysis does not incorporate an explicit parental investment mechanism capable of explaining how increases in parental income translate into discrete changes in investment decisions and, consequently, into endogenous changes in the slope of intergenerational transmission at the top of the distribution.

Our approach is also related to \textcite{Becker_2018}, who show that children’s income is convex in parental human capital and that economic dynasties may emerge. In their framework, this result arises from complementarities in human capital production \parencite{Cunha_2007}, whereby parental human capital increases productivity both in the labor market and in children’s skill formation. In contrast, in our model income convexity and intergenerational persistence emerge from differences in market returns to human capital beyond certain investment levels, even in the absence of technological complementarities in skill production. In this sense, our mechanism provides an alternative and complementary explanation for the emergence of economic dynasties and non-linearities in the IGE.

Finally, this paper relates to \textcite{Solon_2004}, who shows that global increases in returns to human capital, combined with higher levels of inequality, raise the intergenerational elasticity of income in line with the Great Gatsby Curve. However, in that framework inequality is treated as exogenous, and the role of parental investment decisions or endogenous changes in the structure of human capital returns is not examined. In this respect, our model complements this literature by endogenizing parental investment responses to changes in returns and by showing how these responses can generate persistent non-linearities in intergenerational mobility.
